...
# https://docs.microsoft.com/en-us/python/api/azure-mgmt-resource/azure.mgmt.resource.resources.v2019_05_10.models.genericresourceexpanded?view=azure-python
# https://stackify.com/how-to-use-python-profilers-learn-the-basics/
# https://github.com/joerick/pyinstrument#statistical-profiling-not-tracing
